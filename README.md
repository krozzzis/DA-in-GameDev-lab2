...
В ходе работы была смоделирована система урона, где здоровье персонажа уменьшается на случайных интервалах времени, а данные записаны и визуализированы в Google Sheets.
Результаты моделирования подгружаются проектом на Unity.
